dic = {'1': 'none', '2': 'none', '3': 'none', '4': 'none', '5': 'none', '6': 'none', '7': 'none', '8': 'none', '9': 'none', '10': 'none', '11': 'none', '12':
...
import os
path_name_lst = path.split("\\")[1]
print(path_name_lst)
# print(os.path.join("../" + path_name_lst[0] + "/" + path_name_lst[1]))
